...
//（APP测试三板斧）第二板：frida+一键hook脚本绕过SSL Pining https://blog.csdn.net/ggzhifeng/article/details/107606692
//能绕过绝大部分单向证书绑定。
//还是不适用双向证书，还是需要分析app包逆向分析证书密码。
//类似脚本安卓证书锁定解除的工具 https://github.com/WooyunDota/DroidSSLUnpinning
//xposed版本直接使用 https://github.com/Fuzion24/JustTrustMe
